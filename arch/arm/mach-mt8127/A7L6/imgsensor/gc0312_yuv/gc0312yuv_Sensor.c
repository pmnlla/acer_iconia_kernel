...
void GC0312_Sensor_Init(void)
{
	...
	GC0312_write_cmos_sensor(0x95, 0x12); 
...
*/
	...
	GC0312_write_cmos_sensor(0xd3, 0x42); 
...
void GC0312_get_AEAWB_lock(UINT32 *pAElockRet32, UINT32 *pAWBlockRet32)
{
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
		GC0312_get_AEAWB_lock((UINT32 *)(*pFeatureData32),(UINT32 *) (*(pFeatureData32 + 1))); //yangce added for AE_lock CTS
		break;
