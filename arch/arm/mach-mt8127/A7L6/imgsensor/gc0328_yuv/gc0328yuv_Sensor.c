...
void GC0328GammaSelect(kal_uint32 GammaLvl)
{
	switch(GammaLvl)
	{
		...
		default:
			//GC0328_RGB_Gamma_m1
			GC0328_write_cmos_sensor(0xfe, 0x00);
			GC0328_write_cmos_sensor(0xbf, 0x08); // 0312 default gamma
			GC0328_write_cmos_sensor(0xc0, 0x16);
			GC0328_write_cmos_sensor(0xc1, 0x28);
			GC0328_write_cmos_sensor(0xc2, 0x41);
			GC0328_write_cmos_sensor(0xc3, 0x5a);
			GC0328_write_cmos_sensor(0xc4, 0x6c);
			GC0328_write_cmos_sensor(0xc5, 0x7a);
			GC0328_write_cmos_sensor(0xc6, 0x96);
			GC0328_write_cmos_sensor(0xc7, 0xac);
			GC0328_write_cmos_sensor(0xc8, 0xbc);
			GC0328_write_cmos_sensor(0xc9, 0xc9);
			GC0328_write_cmos_sensor(0xca, 0xd3);
			GC0328_write_cmos_sensor(0xcb, 0xdd);
			GC0328_write_cmos_sensor(0xcc, 0xe5);
			GC0328_write_cmos_sensor(0xcd, 0xf1);
...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0x82 , 0x1f);//0x90 jon
	...
	GC0328_write_cmos_sensor(0x95 , 0x11);//0x35 jon  
	
	///////YCP
	GC0328_write_cmos_sensor(0xd1 , 0x20);//0x32 jon
	GC0328_write_cmos_sensor(0xd2 , 0x20);
	GC0328_write_cmos_sensor(0xd3 , 0x30);
	GC0328_write_cmos_sensor(0xd4 , 0xa0);
	...
	GC0328_write_cmos_sensor(0x13 , 0x98);    ///  lanking +2
	...
	///cct       
	GC0328_write_cmos_sensor(0xB1 , 0x08);   
	GC0328_write_cmos_sensor(0xB2 , 0xf4);   
...
BOOL GC0328_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0x98);  //////// lanking
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_10:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0xb0);
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_13:
			...
			GC0328_write_cmos_sensor(0xfe, 0x01);
			GC0328_write_cmos_sensor(0x13, 0xb8);  //  lanking
			GC0328_write_cmos_sensor(0xfe, 0x00);
		break;
		default:
		return FALSE;
...
void GC0328_get_AEAWB_lock(UINT32 *pAElockRet32, UINT32 *pAWBlockRet32)
{
...
#if 1//defined (ATA_TEST)    add clj 20150516 
												
#define GC0328_TEST_PATTERN_CHECKSUM     (0x678da38e)

		UINT32 GC0328SetTestPatternMode(kal_bool bEnable)
		{	 
		printk("GC0328SetTestPatternMode bEnable=%d\n",bEnable);	 
		...
		GC0328_write_cmos_sensor(0xfa,0x32); 
															   
		GC0328_write_cmos_sensor(0x40,0x08); 
		GC0328_write_cmos_sensor(0x41,0x00); 
		GC0328_write_cmos_sensor(0x42,0x00); 
		GC0328_write_cmos_sensor(0x4f,0x00); 
															   
		GC0328_write_cmos_sensor(0x18,0x06); 
															   
		GC0328_write_cmos_sensor(0x77,0x40); 
		GC0328_write_cmos_sensor(0x78,0x40); 
		GC0328_write_cmos_sensor(0x79,0x40); 
		GC0328_write_cmos_sensor(0xd0,0x40); 
		GC0328_write_cmos_sensor(0xdd,0x00); 
		...
		GC0328_write_cmos_sensor(0x4c,0x00);	 
		mDELAY(100);
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
		GC0328_get_AEAWB_lock((UINT32 *)(*pFeatureData32),(UINT32 *) (*(pFeatureData32 + 1))); //yangce added for AE_lock CTS
		break;
...
#if 1 //defined (ATA_TEST)  clj 20150516
