...

{
	...
	*sensorID=((GC2145_read_cmos_sensor(0xf0) << 8) | GC2145_read_cmos_sensor(0xf1));	
	...
	SENSORDB("zhougq Read Sensor ID success = 0x%04x\n", *sensorID); 
...
static void GC2145_Sensor_Init(void)
{
	...
	GC2145_write_cmos_sensor(0x17 , 0x14); //mirror
	...
	GC2145_write_cmos_sensor(0x13 , 0x78);//0x7b jon
	...
	GC2145_write_cmos_sensor(0x82 , 0x0a);//0x05 jon
	GC2145_write_cmos_sensor(0x83 , 0x0a);//0x08 jon
	...
	/////////////////////////////////////////////// 
	GC2145_write_cmos_sensor(0xfe , 0x02);
	GC2145_write_cmos_sensor(0xd1 , 0x38);
	GC2145_write_cmos_sensor(0xd2 , 0x38);
	GC2145_write_cmos_sensor(0xd3 , 0x40);//0x40 jon
	GC2145_write_cmos_sensor(0xd5 , 0x00);//add jon
	...
	//////////////////////////////////////////
	GC2145_write_cmos_sensor(0xfe , 0x01);
  GC2145_write_cmos_sensor(0xa1,0x8d);// center_row
  GC2145_write_cmos_sensor(0xa2,0x67);// center_col
  GC2145_write_cmos_sensor(0xa4,0x77);// sign of b1
  GC2145_write_cmos_sensor(0xa5,0x77);// sign of b1
  GC2145_write_cmos_sensor(0xa6,0x04);// sign of b4
  GC2145_write_cmos_sensor(0xa7,0x75);// sign of b4
  GC2145_write_cmos_sensor(0xa8,0x00);// sign of b22
  GC2145_write_cmos_sensor(0xa9,0x00);// sign of b22
  GC2145_write_cmos_sensor(0xaa,0x13);// Q1_b1 of R
  GC2145_write_cmos_sensor(0xab,0x13);// Q1_b1 of G
  GC2145_write_cmos_sensor(0xac,0x1c);// Q1_b1 of B
  GC2145_write_cmos_sensor(0xad,0x14);// Q2_b1 of R
  GC2145_write_cmos_sensor(0xae,0x15);// Q2_b1 of G
  GC2145_write_cmos_sensor(0xaf,0x17);// Q2_b1 of B
  GC2145_write_cmos_sensor(0xb0,0x13);// Q3_b1 of R
  GC2145_write_cmos_sensor(0xb1,0x0c);// Q3_b1 of G
  GC2145_write_cmos_sensor(0xb2,0x18);// Q3_b1 of B
  GC2145_write_cmos_sensor(0xb3,0x11);// Q4_b1 of R
  GC2145_write_cmos_sensor(0xb4,0x08);// Q4_b1 of G
  GC2145_write_cmos_sensor(0xb5,0x0a);// Q4_b1 of B
  GC2145_write_cmos_sensor(0xb6,0x4a);// right_b2 of R
  GC2145_write_cmos_sensor(0xb7,0x37);// right_b2 of G
  GC2145_write_cmos_sensor(0xb8,0x37);// right_b2 of B
  GC2145_write_cmos_sensor(0xb9,0x02);// right_b4 of R
  GC2145_write_cmos_sensor(0xba,0x07);// right_b4 of G
  GC2145_write_cmos_sensor(0xbb,0x01);// right_b4 of B
  GC2145_write_cmos_sensor(0xbc,0x42);// left_b2 of R
  GC2145_write_cmos_sensor(0xbd,0x30);// left_b2 of G
  GC2145_write_cmos_sensor(0xbe,0x26);// left_b2 of B
  GC2145_write_cmos_sensor(0xbf,0x05);// left_b4 of R
  GC2145_write_cmos_sensor(0xc0,0x03);// left_b4 of G
  GC2145_write_cmos_sensor(0xc1,0x0b);// left_b4 of B
  GC2145_write_cmos_sensor(0xc2,0x2c);// up_b2 of R
  GC2145_write_cmos_sensor(0xc3,0x1f);// up_b2 of G
  GC2145_write_cmos_sensor(0xc4,0x1d);// up_b2 of B
  GC2145_write_cmos_sensor(0xc5,0x16);// up_b4 of R
  GC2145_write_cmos_sensor(0xc6,0x0a);// up_b4 of G
  GC2145_write_cmos_sensor(0xc7,0x0c);// up_b4 of B
  GC2145_write_cmos_sensor(0xc8,0x31);// down_b2 of R
  GC2145_write_cmos_sensor(0xc9,0x1d);// down_b2 of G
  GC2145_write_cmos_sensor(0xca,0x23);// down_b2 of B
  GC2145_write_cmos_sensor(0xcb,0x24);// down_b4 of R
  GC2145_write_cmos_sensor(0xcc,0x09);// down_b4 of G
  GC2145_write_cmos_sensor(0xcd,0x22);// down_b4 of B
  GC2145_write_cmos_sensor(0xd0,0x66);// right_up_b22 of R
  GC2145_write_cmos_sensor(0xd1,0x5a);// right_up_b22 of G
  GC2145_write_cmos_sensor(0xd2,0x78);// right_up_b22 of B
  GC2145_write_cmos_sensor(0xd3,0x26);// right_down_b22 of R
  GC2145_write_cmos_sensor(0xd4,0x1c);// right_down_b22 of G
  GC2145_write_cmos_sensor(0xd5,0x26);// right_down_b22 of B
  GC2145_write_cmos_sensor(0xd6,0x3c);// left_up_b22 of R
  GC2145_write_cmos_sensor(0xd7,0x4b);// left_up_b22 of G
  GC2145_write_cmos_sensor(0xd8,0x6c);// left_up_b22 of B
  GC2145_write_cmos_sensor(0xd9,0x0b);// left_down_b22 of R
  GC2145_write_cmos_sensor(0xda,0x05);// left_down_b22 of G
  GC2145_write_cmos_sensor(0xdb,0x3c);// left_down_b22 of B	
	GC2145_write_cmos_sensor(0xfe , 0x01);
	...
	GC2145_write_cmos_sensor(0xe7 , 0x80); // a0
	...
	GC2145_write_cmos_sensor(0x4e , 0x06);    // A                        
	GC2145_write_cmos_sensor(0x4c , 0x02);
	...
	GC2145_write_cmos_sensor(0xc1 , 0x40);
	GC2145_write_cmos_sensor(0xc2 , 0xfc);
	GC2145_write_cmos_sensor(0xc3 , 0x05);
	...
	GC2145_write_cmos_sensor(0x27 , 0x06); 
	GC2145_write_cmos_sensor(0x28 , 0xd6); //20fps 
	GC2145_write_cmos_sensor(0x29 , 0x07); 
	GC2145_write_cmos_sensor(0x2a , 0xd0); //14fps 
	GC2145_write_cmos_sensor(0x2b , 0x0b); 
	GC2145_write_cmos_sensor(0x2c , 0xb8); //12fps
	GC2145_write_cmos_sensor(0x2d , 0x0f); 
	GC2145_write_cmos_sensor(0x2e , 0xa0); //8fps
	GC2145_write_cmos_sensor(0xfe , 0x00);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->VideoDelayFrame = 4; //add clj 20150626
...
BOOL GC2145_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2145_write_cmos_sensor(0x27 , 0x06); 
		GC2145_write_cmos_sensor(0x28 , 0x80); //20fps //4e0 jon
		GC2145_write_cmos_sensor(0x29 , 0x08); 
		GC2145_write_cmos_sensor(0x2a , 0x20); //14fps //680 jon
		GC2145_write_cmos_sensor(0x2b , 0x09); 
		GC2145_write_cmos_sensor(0x2c , 0xc0); //12fps //820 jon
...
BOOL GC2145_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		case AE_EV_COMP_n30:
			GC2145_SET_PAGE1;
			GC2145_write_cmos_sensor(0x13,0x44);
			GC2145_SET_PAGE0;
		break;
		case AE_EV_COMP_n20:
			GC2145_SET_PAGE1;
			GC2145_write_cmos_sensor(0x13,0x58);
			GC2145_SET_PAGE0;
		break;
		case AE_EV_COMP_n10:
			GC2145_SET_PAGE1;
			GC2145_write_cmos_sensor(0x13,0x6c);
			GC2145_SET_PAGE0;
		break;
		case AE_EV_COMP_00:
			GC2145_SET_PAGE1;
		...
		case AE_EV_COMP_10:
			GC2145_SET_PAGE1;
			GC2145_write_cmos_sensor(0x13,0x94);
			GC2145_SET_PAGE0;
		break;
		case AE_EV_COMP_20:
			GC2145_SET_PAGE1;
			GC2145_write_cmos_sensor(0x13,0xa8);
			GC2145_SET_PAGE0;
		break;
		case AE_EV_COMP_30:
			GC2145_SET_PAGE1;
			GC2145_write_cmos_sensor(0x13,0xbc);
			GC2145_SET_PAGE0;
		break;
		default:
		return FALSE;
...
//	   return TRUE;
	...
	switch (iCmd) {
	case FID_SCENE_MODE:	    
	    printk("cljSet FID_SCENE_MODE:%d\n", iPara); 
//add clj 20150506
#if 0
	...
	case FID_AE_SCENE_MODE:
		...
		printk("cljSet FID_AE_SCENE_MODE:%d\n", iPara);
...
UINT32 GC2145GetDefaultFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 *pframeRate) 
{
 ...
 void GC2145_get_AEAWB_lock(UINT32 *pAElockRet32, UINT32 *pAWBlockRet32)
 {
	 //OV2659SENSORDB("[GC0312_get_AEAWB_lock]\n");  
	 
	 *pAElockRet32 = 1;
	 *pAWBlockRet32 = 1;
 }
		 //yangce added for AE_lock CTS

#if 1//defined (ATA_TEST)    add clj 20150513 
        
	UINT32 GC2145SetTestPatternMode(kal_bool bEnable)
	{	 
	printk("GC2145SetTestPatternMode bEnable=%d\n",bEnable);	 
		...
		GC2145_write_cmos_sensor(0xfe,0x00); 
		GC2145_write_cmos_sensor(0xfa,0x32);//clj 20150515								  
		GC2145_write_cmos_sensor(0x80,0x08); 
		GC2145_write_cmos_sensor(0x81,0x00); 
		GC2145_write_cmos_sensor(0x82,0x00); 
		GC2145_write_cmos_sensor(0xb6,0x00); 
										  
		GC2145_write_cmos_sensor(0x18,0x06); 
										  
		GC2145_write_cmos_sensor(0xb3,0x40); 
		GC2145_write_cmos_sensor(0xb4,0x40); 
		GC2145_write_cmos_sensor(0xb5,0x40); 
										  
		GC2145_write_cmos_sensor(0xfe,0x02); 
		GC2145_write_cmos_sensor(0xd0,0x40); 
		GC2145_write_cmos_sensor(0xdd,0x00); 
										  
		GC2145_write_cmos_sensor(0xfe,0x00); 
		GC2145_write_cmos_sensor(0xb1,0x40); 
		GC2145_write_cmos_sensor(0xb2,0x40); 
		GC2145_write_cmos_sensor(0x03,0x00); 
		GC2145_write_cmos_sensor(0x04,0x00); 
										  
		GC2145_write_cmos_sensor(0x8c,0x01); 
			}	 
		else	 
		GC2145_write_cmos_sensor(0x8c,0x00); 	 
		mDELAY(100);

		return ERROR_NONE;
	}
                                            
   #define GC2145_TEST_PATTERN_CHECKSUM     (0xe3a2c8c4)
#endif
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
			GC2145_get_AEAWB_lock((UINT32 *)(*pFeatureData32),(UINT32 *) (*(pFeatureData32 + 1))); //yangce added for AE_lock CTS
			break;
		...
		GC2145YUVSensorSetting((FEATURE_ID)*pFeatureData32, *(pFeatureData32+1));  //modify clj 20150410 
...
#if 1 //defined (ATA_TEST)  clj 20150513

	case SENSOR_FEATURE_SET_TEST_PATTERN:
		printk("______%s______\n",__func__);
